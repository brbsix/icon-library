...
class IconLibraryGui:
    ...
    def setup_listviews(self, Controller, Display):
        ...
        filters_view.connect("changed", Controller.context_filter_cb) 
    ...
    def setup_bottom_toolbar(self, vbox, Display):
        ...
        for widget in [Display.filters_view, self.color_swatches_hbox, self.status_hbox,self.export_button]:
          btm_hbox.add(widget)
          btm_hbox.set_child_packing(widget,False,False,0,gtk.PACK_START)
        
        btm_hbox.set_child_packing(self.status_hbox,True,True,0,gtk.PACK_START)
